...
if __name__ == "__main__":
    ...
    # frame_objects = read_result("/home/linkdata/data/tmm/eval/data/mango/test/73-1.json", "/home/linkdata/data/tmm/eval/data/mango/test/73-2.json")
    frame_objects = read_result("/home/linkdata/data/tmm/eval/data/suppliment/62-1.json", "/home/linkdata/data/tmm/eval/data/suppliment/62-2.json")
    # frame_objects = read_result("/home/linkdata/data/tmm/eval/data/global/59-1.json", "/home/linkdata/data/tmm/eval/data/global/59-2.json")
    # frame_objects = read_result("/home/linkdata/data/tmm/eval/data/localglobal/48-1.json", "/home/linkdata/data/tmm/eval/data/localglobal/48-2.json")

    
    gt_targets_A = read_gt("/home/linkdata/data/tmm/eval/data/gt/test/62-1.txt", 1)
    gt_targets_B = read_gt("/home/linkdata/data/tmm/eval/data/gt/test/62-2.txt", 2)
    frame_objects = assign_gt_to_frames(frame_objects, gt_targets_A, gt_targets_B)    # 完成以帧为key的数据结构构建


    calAAS(frame_objects)


    # sequences_result = os.listdir("/home/linkdata/data/tmm/eval/data/mango/all/")
    # sequences_result.sort()
    # sequences_gt = os.listdir("/home/linkdata/data/tmm/eval/data/gt/all/")
    # sequences_gt.sort()
    ...
    #     result_path_A = "/home/linkdata/data/tmm/eval/data/mango/all/" + sequences_result[i]
    #     result_path_B = "/home/linkdata/data/tmm/eval/data/mango/all/" + sequences_result[i+1]
    #     gt_path_A = "/home/linkdata/data/tmm/eval/data/gt/all/" + sequences_gt[i]
    #     gt_path_B = "/home/linkdata/data/tmm/eval/data/gt/all/" + sequences_gt[i+1]
