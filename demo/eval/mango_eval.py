...
if __name__ == "__main__":
    ...
    parser.add_argument('--sequences_result', default="/root/mmtracking-master/json_resultfiles/Firstframe_initialized_bytetrack_autoassign_full_mdmt-private-half/", help="test file directory")
